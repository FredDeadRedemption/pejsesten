...
pub fn build_cards() -> Vec<Card> {
    vec![
        ...
        Card::Minion(MinionCard {
            ...
            description: Some("<strong>Tradeable</strong><br><strong>Engage</strong>".to_string()),
            flavor_text: None,
            base_cost: 1,
        ...
        Card::Minion(MinionCard {
            ...
            description: Some("<strong>Guard</strong><br><strong>Fanfare:</strong> Draw a card".to_string()),
            flavor_text: None,
            base_cost: 1,
